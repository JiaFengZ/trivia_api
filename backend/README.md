...
```
- Sample: `curl http://127.0.0.1:5000/questions -X POST -H "Content-Type: application/json" -d '{"question":"What movie earned Tom Hanks his third straight Oscar nomination, in 1996?", "answer":"Apollo 13", "difficulty":1, "category":1}'`
```
{
  "created": 25, 
  "questions": [
...
- General:
  - Returns questions based on a search term
- Request Arguments:
```
{
  search_term: str
...
```
- Sample: `curl http://127.0.0.1:5000/questions/search -X POST -H "Content-Type: application/json" -d '{"search_term":"earned"}'`
```
{
  "questions": [
    {
...
#### POST /quizzes
- General:
  - Returns random questions to play the quiz baseon category and previous question parameters 
- Request Arguments:
```
{
